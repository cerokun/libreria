...
--
-- Host: localhost
-- Generation Time: Jun 09, 2019 at 04:08 AM
...
(3, 'Terror', 'Novelas genero terror', 'Aqui en anuncio libros terror', 'Ter', 1),
...
`idPedido` int(11) NOT NULL,
  ...
  `correo` varchar(65) COLLATE utf8_spanish_ci NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=197 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='Guarda los pedidos realizados por los clientes, un cliente podra realizar tantos pedidos como desee y cada pedido es unico de un cliente.';

--
-- Dumping data for table `pedidos`
--

INSERT INTO `pedidos` (`idPedido`, `estado`, `fecha`, `nombre`, `apellidos`, `dni`, `correo`, `direccion`, `codigoPostal`, `provincia`, `cancelar`, `idUsuario`) VALUES
(193, 1, '2019-06-08 18:22:35', 'Jose Luis', 'Cortes', '48927740R', 'joseluiscortesrapela.jl@gmail.com', 'Calle Praltra 5', 21004, '21', 0, 38),
(194, 1, '2019-06-08 18:25:13', 'Jose Luis', 'Cortes', '48927740R', 'joseluiscortesrapela.jl@gmail.com', 'Calle Praltra 5', 21004, '21', 0, 38),
(195, 1, '2019-06-08 20:34:33', 'Jose Luis', 'Cortes', '48927740R', 'joseluiscortesrapela.jl@gmail.com', 'Calle Praltra 5', 21004, '21', 0, 38),
(196, 1, '2019-06-09 01:41:43', 'Jose Luis', 'Cortes', '48927740R', 'joseluiscortesrapela.jl@gmail.com', 'Calle Praltra 5', 21004, '21', 0, 38);
...
(39, 'Cicero', 'joseluiscortesrapela.jl@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 'Serena', 'Argiolas', '48927740r', 'Avd Tolomeo 5', 21005, '41', 0, '0', 'administrador');
...
--
ALTER TABLE `lineaDePedido`
MODIFY `idItem` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=392;
--
-- AUTO_INCREMENT for table `pedidos`
--
ALTER TABLE `pedidos`
MODIFY `idPedido` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=197;
--
...
--
ALTER TABLE `lineaDePedido`
ADD CONSTRAINT `lineaDePedido_ibfk_1` FOREIGN KEY (`idProducto`) REFERENCES `productos` (`idProducto`) ON DELETE NO ACTION ON UPDATE NO ACTION;
